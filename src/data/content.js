...
export const aboutStory = [
  '在行醫的過程中，我始終相信最重要的價值，是基於「紮實的醫學實證和臨床經驗」，給予「真誠且理解人心的照護」。',
  '因為我深知，父母對孩子身高和發育的焦慮，不只是外表的問題，這件事牽動著孩子與父母的自信和生活品質。許多不安，其實源自於同儕比較的壓力與醫學資訊的落差。',
  '我傾聽每位家長的聲音，以專業釐清迷思、化解不必要的擔憂。同時，要發揮孩子最大的成長潛力，絕不能仰賴憑空臆測或人云亦云的療法，而是需要醫學實證與臨床經驗作為基石。',
  '兒童成長議題是一道寬廣的光譜——從需要及早揪出的內分泌疾病、游移在邊界的亞疾病／亞健康狀態，到好還想更好、追求更理想身高的個體化需求。',
  '歷經台大兒科、台大兒童內分泌科的完整訓練，同時取得了兒科專科、兒科醫學會內分泌次專科、兒科醫學會青少年次專科、台灣糖尿病與內分泌學會這四個專科執照，以及醫學中心多年主治醫師的臨床淬鍊，我始終以國際實證醫學文獻為本，並融入多年第一線的治療經驗，在這個寬廣的光譜內，無論是敏銳診斷潛在疾病、客觀評估各類藥物和輔助方案，我都堅持精準診斷、充分告知，在安全與效益之間取得平衡。',
